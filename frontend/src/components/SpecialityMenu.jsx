...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Our Expert Doctors</h1>
            <p className='sm:w-1/3 text-center text-sm'>Book you appointment with our highly qualified doctors, for hassle free treatment.</p>
